# Contributing to MacOS-Use

Thank you for your interest in contributing to MacOS-Use! This document provides guidelines and instructions for contributing to this project.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/macos-use.git
   cd macos-use
   ```
...
Thank you for contributing to MacOS-Use!
