...
**MacOS-Use directly interacts with your operating system at the GUI layer and executes commands with the same privileges as the user running the agent. There is currently NO sandbox or isolation layer provided.**
...
2. **Access Control**
   ...
   - Use macOS System Integrity Protection (SIP) and Gatekeeper appropriately
...
- [ ] Ensure you're in a safe environment (VM or isolated machine)
...
If you discover a security vulnerability in MacOS-Use, please report it responsibly:
...
If you're contributing to MacOS-Use, please:
...
MacOS-Use is provided "as is" without warranty of any kind. The maintainers and contributors are not responsible for:
- Data loss
- System damage
- Security breaches
...
By using MacOS-Use, you acknowledge and accept these risks.
